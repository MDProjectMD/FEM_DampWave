...
object_file = run.o Define.o Random.o SystemDefine.o Stochastic.o TimeDependentSolver.o
...
run.o	:	run.cpp  Stochastic.h Define.h MatLib.h Matrix.h
...
TimeDependentSolver.o	:	TimeDependentSolver.cpp TimeDependentSolver.h
	$(CC) -c TimeDependentSolver.cpp -o TimeDependentSolver.o -I$(INCLUDE_EIGEN)
